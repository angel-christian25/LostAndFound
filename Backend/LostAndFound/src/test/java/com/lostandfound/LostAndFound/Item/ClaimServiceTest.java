...
class ClaimServiceTest {
  ...
  @Test
  void testClaimRequestedSuccessful() {
    // arrange
  ...
  @Test
  void testClaimRequestedItemNotFound() {
    // arrange
  ...
  @Test
  void testClaimRequestedLostItemNotFound() {
    // arrange
    when(itemRepository.findById(foundItem.getId())).thenReturn(Optional.of(foundItem));
  ...
  @Test
  void testClaimRequestedItemPostedByUser() {
    // arrange
    when(itemRepository.findById(foundItem.getId())).thenReturn(Optional.of(foundItem));
    when(itemRepository.findById(lostItem.getId())).thenReturn(Optional.of(lostItem));
  ...
  @Test
  void testClaimRequestedItemPostedByClaimRequestUser() {
    // arrange
    when(itemRepository.findById(foundItem.getId())).thenReturn(Optional.of(foundItem));
    when(itemRepository.findById(lostItem.getId())).thenReturn(Optional.of(lostItem));
  ...
  @Test
  void testClaimRequestedAlreadyAccepted() {
    // arrange
    when(itemRepository.findById(foundItem.getId())).thenReturn(Optional.of(foundItem));
    when(itemRepository.findById(lostItem.getId())).thenReturn(Optional.of(lostItem));
  ...
  @Test
  void testClaimRequestedAlreadyRejected() {
    // arrange
    when(itemRepository.findById(foundItem.getId())).thenReturn(Optional.of(foundItem));
    when(itemRepository.findById(lostItem.getId())).thenReturn(Optional.of(lostItem));
  ...
  @Test
  void testClaimRequestedItemAlreadyRequested() {
    // arrange
    when(itemRepository.findById(foundItem.getId())).thenReturn(Optional.of(foundItem));
    when(itemRepository.findById(lostItem.getId())).thenReturn(Optional.of(lostItem));
  ...
  @Test
  void testClaimRequestedItemAlreadyClaimed() {
    // arrange
    when(itemRepository.findById(foundItem.getId())).thenReturn(Optional.of(foundItem));
    when(itemRepository.findById(lostItem.getId())).thenReturn(Optional.of(lostItem));
  ...
  @Test
  void testClaimRequestedItemAlreadyClaimedAccepted() {
    // arrange
    when(itemRepository.findById(foundItem.getId())).thenReturn(Optional.of(foundItem));
    when(itemRepository.findById(lostItem.getId())).thenReturn(Optional.of(lostItem));
  ...
  @Test
  void testClaimRequestAcceptedSuccessful() {
    // arrange
    when(itemRepository.findById(foundItem.getId())).thenReturn(Optional.of(foundItem));
  ...
  @Test
  void testClaimRequestAcceptedItemNotFound() {
    // arrange
    when(itemRepository.findById(foundItem.getId())).thenReturn(Optional.empty());
  ...
  @Test
  void testClaimRequestAcceptedItemAlreadyClaimed() {
    // arrange
    when(itemRepository.findById(foundItem.getId())).thenReturn(Optional.of(foundItem));
  ...
  @Test
  void testClaimRequestAcceptedItemPostedByUser() {
    // arrange
    when(itemRepository.findById(foundItem.getId())).thenReturn(Optional.of(foundItem));
  ...
  @Test
  void testClaimRequestAcceptedItemPostedByClaimRequestUser() {
    // arrange
    when(itemRepository.findById(foundItem.getId())).thenReturn(Optional.of(foundItem));
  ...
  @Test
  void testClaimRequestAcceptedItemClaimRequestNotYetRaised() {
    // arrange
    when(itemRepository.findById(foundItem.getId())).thenReturn(Optional.of(foundItem));
  ...
  @Test
  void testClaimRequestAcceptedItemClaimRequestAlreadyAccepted() {
    // arrange
    when(itemRepository.findById(foundItem.getId())).thenReturn(Optional.of(foundItem));
  ...
  @Test
  void testRevokeClaimRequestSuccessful() {
    // arrange
    when(itemRepository.findById(foundItem.getId())).thenReturn(Optional.of(foundItem));
    foundItem.getClaimRequested().put(lostItem.getId(), lostItem.getCreatedBy());
  ...
  @Test
  void testRevokeClaimRequestItemNotFound() {
    // arrange
    when(itemRepository.findById(foundItem.getId())).thenReturn(Optional.empty());
  ...
  @Test
  void testRevokeClaimRequestItemClaimRequestNotYetRaised() {
    // arrange
    when(itemRepository.findById(foundItem.getId())).thenReturn(Optional.of(foundItem));
  ...
  @Test
  void testApproveClaimSuccessful() {
    // arrange
    when(itemRepository.findById(foundItem.getId())).thenReturn(Optional.of(foundItem));
  ...
  @Test
  void testApproveClaimItemNotFound() {
    // arrange
    when(itemRepository.findById(foundItem.getId())).thenReturn(Optional.empty());
  ...
  @Test
  void testApproveClaimItemAlreadyClaimed() {
    // arrange
    when(itemRepository.findById(foundItem.getId())).thenReturn(Optional.of(foundItem));
  ...
  @Test
  void testApproveClaimItemPostedByUser() {
    // arrange
    when(itemRepository.findById(foundItem.getId())).thenReturn(Optional.of(foundItem));
  ...
  @Test
  void testApproveClaimItemPostedByClaimRequestUser() {
    // arrange
    when(itemRepository.findById(foundItem.getId())).thenReturn(Optional.of(foundItem));
  ...
  @Test
  void testApproveClaimItemClaimRequestNotYetAccepted() {
    // arrange
    when(itemRepository.findById(foundItem.getId())).thenReturn(Optional.of(foundItem));
  ...
  @Test
  void testRejectClaimSuccessful() {
    // arrange
    when(itemRepository.findById(foundItem.getId())).thenReturn(Optional.of(foundItem));
    foundItem.getClaimRequestAccepted().put(lostItem.getId(), lostItem.getCreatedBy());
  ...
  @Test
  void testRejectClaimItemNotFound() {
    // arrange
    when(itemRepository.findById(foundItem.getId())).thenReturn(Optional.empty());
  ...
  @Test
  void testRejectClaimItemAlreadyRejected() {
    // arrange
    when(itemRepository.findById(foundItem.getId())).thenReturn(Optional.of(foundItem));
    foundItem.getClaimRejected().put(lostItem.getId(), lostItem.getCreatedBy());
